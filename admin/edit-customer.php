...
<?php } ?>
        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
                ...
                <?php
            $kd = $_GET['kd_cus'];
			$sql = mysqli_query($koneksi, "select c.kd_cus, c.nama as nama_cus ,c.alamat as alamat, c.no_telp, c.username,c.password,c.gambar,p.id_prov as id_prov, p.nama as prov ,k.id_kab as id_kab, k.nama as kota ,kc.id_kec as id_kec, kc.nama as kec from customer c join provinsi p on c.id_provinsi=p.id_prov 
JOIN kabupaten k on c.id_kota=k.id_kab join kecamatan kc on c.id_kecamatan=kc.id_kec WHERE c.kd_cus='$kd'");
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="update-customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nama" type="text" id="nama" value="<?php echo $row['nama_cus']; ?>" class="form-control" autocomplete="off" placeholder="Nama Customer" autocomplete="off" required />
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <select name="prop" id="prop" onchange="ajaxkota(this.value)">
                                    <option value="<?php echo $row['id_prov']; ?>"><?php echo $row['prov']; ?></option>
                                    <?php 
                                    include 'koneksi.php';
                          ...
                          <div class="form-group"  >
                            ...
                            <select name="kota" id="kota" onchange="ajaxkec(this.value)">
                                <option value="<?php echo $row['id_kab']; ?>"><?php echo $row['kota']; ?></option>
                              </select>
                            ...
                            <select name="kec" id="kec" onchange="ajaxkel(this.value)">
                                <option value="<?php echo $row['id_kec']; ?>"><?php echo $row['kec']; ?></option>
                              </select>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="nama_file" type="file" id="nama_file" class="form-control" value="<?php echo $row['gambar']; ?>" required />
