...
if (!empty($_FILES["nama_file"]["tmp_name"]))
{
	...
	{			
		...
		if (move_uploaded_file($_FILES['nama_file']['tmp_name'], $gambar)) {
			$sql="INSERT INTO customer(kd_cus,nama,alamat,no_telp,username,password,gambar,id_provinsi,id_kota,id_kecamatan) VALUES
            ('$kode','$nama','$alamat','$no_telp','$username','$password','$gambar','$id_provinsi','$id_kota','$id_kecamatan')";
                  ...
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-customer.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                            <input name="password" type="password" id="password" class="form-control" autocomplete="off" placeholder="Password" autocomplete="off" required />
