...
$namafolder="gambar_customer/"; //tempat menyimpan file
  ...
  //       $nama     = $_POST['nama'];
        ...
        $cekno= mysqli_query($koneksi, "SELECT * FROM ongkir ORDER BY id_ongkir DESC");
        ...
        $kode=$no1.$next1;
			...
			$sql="INSERT INTO ongkir(id_ongkir,id_provinsi,id_kota,id_kecamatan,tarif_ongkir) VALUES
            ('$kode','$id_provinsi','$id_kota','$id_kecamatan','$tarif_ongkir')";
			$res=mysqli_query($koneksi, $sql) or die (mysqli_error());

			//echo "Gambar berhasil dikirim ke direktori".$gambar;
            echo "<script>alert('Data Customer berhasil dimasukan!'); window.location = 'ongkir.php'</script>";	   
	...
	echo "Data Gagal Disimpan";
           ...
           <!-- /.row -->
                    ...
                    <div class="row">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Input Data Ongkir </h3> 
                        </div>
                        <div class="panel-body">
                  <div class="form-panel">
                      <form class="form-horizontal style-form" action="input-ongkir.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                          ...
                          <div class="form-group"  >
                            ...
                            <select name="kec" id="kec" onchange="ajaxkel(this.value)">
                             ...
                             <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Tarif Ongkir</label>
                              <div class="col-sm-3">
                            <input name="tarif_ongkir" type="text" id="tarif_ongkir" class="form-control" autocomplete="off" placeholder="Nama Customer" autocomplete="off" required />
