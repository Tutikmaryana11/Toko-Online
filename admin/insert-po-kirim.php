...
if(isset($_POST['input'])){
				...
				if(mysqli_num_rows($cek) == 0){
						$insert = mysqli_query($koneksi, "INSERT INTO po(nopo, style, color, tanggalkirim, tanggalexport, status)
															VALUES('$nopo','$style', '$color', CURRENT_DATE, CURRENT_DATE, 'Proses')") or die(mysqli_error());
						if($insert){
