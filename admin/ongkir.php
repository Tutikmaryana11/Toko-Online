        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">
             ...
             if(isset($_GET['hal']) == 'hapus'){
				$kd_ongkir = $_GET['kd'];
				$cek = mysqli_query($koneksi, "SELECT * FROM ongkir WHERE id_ongkir='$kd_ongkir'");
				if(mysqli_num_rows($cek) == 0){
					echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button> Data tidak ditemukan.</div>';
				}else{
					$delete = mysqli_query($koneksi, "DELETE FROM ongkir WHERE id_ongkir='$kd_ongkir'");
					if($delete){
           ...
           <input type='submit' value='Cari Data' class="btn btn-sm btn-primary" /> <a href='ongkir.php' class="btn btn-sm btn-success" >Refresh</i></a>
          	</div>
              </div>
           <!-- /.row -->
                    <br />
                    ...
                    <div class="panel panel-success">
                        ...
                        <h3 class="panel-title"><i class="fa fa-user"></i> Data Ongkos Kirim </h3> 
                        </div>
                        <div class="panel-body">
                       <!-- <div class="table-responsive"> -->
                    <?php
                    $query1="select * from ongkir";
                    
                    if(isset($_POST['qcari'])){
	               $qcari=$_POST['qcari'];
	               $query1="select c.id_ongkir,c.tarif_ongkir,p.nama as prov, kb.nama as kota, kc.nama as kec from ongkir c JOIN kecamatan kc on c.id_kecamatan=kc.id_kec JOIN kabupaten kb on kc.id_kab=kb.id_kab JOIN provinsi p on kb.id_prov=p.id_prov
	               where id_ongkir like '%$qcari%'
	               or tarif_ongkir like '%$qcari%'  ";
               }
                  ...
                  <thead>
                      <tr>
                        ...
                        <th><center>Kode Ongkir </center></th>
                        <th><center>Provinsi </i></center></th>
              ...
              ?>
                ...
                <div class="text-right">
                  <a href="input-ongkir.php" class="btn btn-sm btn-warning">Tambah Ongkir <i class="fa fa-arrow-circle-right"></i></a>
