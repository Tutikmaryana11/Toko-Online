<br />
                    <ul class="sidebar-menu">
                        <li class="active">
                            <a href="index.php">
                                <i class="glyphicon glyphicon-dashboard"></i> <span>Produk</span>
                            </a>
                        </li>
                        <li class="active">
                        ...
                        <!--<li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="edit-customer.php"><i class="fa fa-angle-double-right"></i> Edit Customer</a></li>
                                <li><a href="detail-customer.php"><i class="fa fa-angle-double-right"></i> Detail Customer</a></li>
                            </ul>
                        </li>-->
                        <!--<li class="treeview">
                            <a href="#">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="cetak-produk.php"><i class="fa fa-angle-double-right"></i> Laporan Produk</a></li>
