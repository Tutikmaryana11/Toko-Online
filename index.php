...
<body>
	...
	<div class="slider-wrapper">
		...
		<div id="da-slider" class="da-slider">
			<div class="da-slide">
				<h2>Scarf</h2>
				<p>Koleksi scarf terbaru yang cantik dan cocok untuk dress polosmu, pilihan warna yang memukau.</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/side1.png" alt="image01" /></div>
			</div>
			<div class="da-slide">
				<h2>Clothing</h2>
				<p>Kami menyediakan Atasan, Bawahan, Dresses & Jumpsuit serta Outwear</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/side4.png" alt="image02" /></div>
			</div>
			<div class="da-slide">
				<h2>Mukena</h2>
				<p>Tampil Cantik dan Elegan Ketika Beribadah Dengan Model Mukena Terbaru</p>
				<a href="produk.php" class="da-link">Lihat Produk</a>
				<div class="da-img"><img src="img/parallax-slider/side3.png" alt="image02" /></div>
			</div>
	...
	<div id="wrapper">
    	...
    	<div class="container">
      		...
      		<div class="hero-unit">
        		<p>
				Welcome to Nurun Nisa!
				Nurul Nisa merupakan distributor busana muslim terlengkap dengan kualitas bagus dan harga terjangkau bagi mereka yang menyukai fashion Hijab.
                </p>
	...
	<input type="text" name="cari">	<input type="submit" value="Cari">
	                ...
	                if(isset($_GET['cari'])){
	                	$cari = $_GET['cari'];
                    $sql = mysqli_query($koneksi, "SELECT * FROM produk where  nama like '%".$cari."%' or jenis  like '%".$cari."%' ORDER BY kode DESC limit 9 ");
                }
                else{
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Kami memberikan kualitas terbaik dalam menyediakan produk busana muslim dengan kualitas terbaik.
							</div>
							<div class="clear"></div>
						</div>
					</div>
					...
					<div class="span6">
						<div class="icons-box-vert">
							...
							<div class="icons-box-vert-info">
								...
								<p>Anda bisa memesan produk kami melalui gadget kesayangan anda, belanja di Nurun Nisa  praktis dan mudah.</p>
							</div>
							<div class="clear"></div>
						</div>
					</div>
